  ...
  return (
    ...
    <div className={styles.main}>
      <section className={styles.top_header}>
        <div className={styles.header_left}>
          <p className={styles.p1}>
            FROM <b className="primary_color">WAREHOUSE</b> TO <br/> DOORSTEP, WE GET <br/>
          ...
          <div className={styles.right_content}>
            <div>
              ...
              <p className={styles.desc}>
                Ensuring smooth and reliable <br/> transportation of goods across
                various locations.
              </p>
            </div>
            ...
            <div>
              ...
              <p className={styles.desc}>
                Offering seamless logistics support, <br/> including warehousing, 
        ...
        <div>
          <div className={styles.left_content}>
            <div>
              ...
              <p className={styles.desc}>
                Delivering goods with precision and speed, focusing on customer
                satisfaction.
              </p>
            </div>
            <div className={styles.divider}></div>
            <div>
              ...
              <p>
                <b className="primary_color">SUPPLY CHAIN</b> <b>CONSULTING</b>
              </p>
              <p className={styles.desc}>
      ...
      <section className={styles.action}>
        <h3>PLUTO ENTERPRISE IN ACTION</h3>
      ...
      <section className={styles.why_choose_us}>
        ...
        <div className={styles.list}>
          ...
          <div>
            ...
            <p className={styles.desc}>More than just a logistics provider. Pluto Enterprise is your ally in growth offering transparent and reliable services to help your business thrive</p>
          </div>

          <div>
            <h6>03</h6>
            <p className={styles.head}>TAILORED LOGISTICS SOLUTIONS: </p>
            <p className={styles.desc}>We offer customized transportation and third-party logistics (3PL) services that adapt to the unique needs of your business, ensuring seamless operations</p>
          </div>

          <div>
            <h6>04</h6>
            <p className={styles.head}>COMMITMENT TO SUSTAINABILITY: </p>
            <p className={styles.desc}>We incorporate sustainable practices into our logistics operations, reducing our environment footprint while maintaining the highest level of services</p>
          </div>
        </div>
      </section>
